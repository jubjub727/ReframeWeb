    ...
    async def test_completion_checker_writes_prompt_layer_entry(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with mock.patch(
                ...
                with mock.patch(
                    "reframe_agent_host.agent_flow.task_completion.baml_task."
                    ...
                    with mock.patch(
                        ...
                        return_value=baml_task.CompletionResult.PASS,
                    ):
        ...
        self.assertEqual(result, baml_task.CompletionResult.PASS)
