...
from reframe_agent_host.benchmarks.config import MemoryRelevanceBenchmarkConfig
from reframe_agent_host.benchmarks.runner import run_memory_relevance_benchmark
...
async def run_benchmark_memory_relevance(
    ...
    return await execute_benchmark(
        config=MemoryRelevanceBenchmarkConfig(**values),
        runner=run_memory_relevance_benchmark,
        output=output,
        output_name="memory-relevance",
